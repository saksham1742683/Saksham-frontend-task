...
const WalletSaleBanner = () => {
  return (
    ...
    <div 
      className="min-h-screen flex items-center justify-end pr-32 font-sans bg-cover bg-center bg-no-repeat relative"
      style={{
    ...
    >
      ...
      <div className="text-right relative z-10">
        ...
        <h1 className="text-5xl font-light text-white tracking-widest my-4 drop-shadow-lg">
          FASHIONABLE WALLETS
        </h1>
        <h1 className="text-5xl font-light text-white tracking-widest drop-shadow-lg">
